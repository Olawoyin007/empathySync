...
# Tests
pytest tests/                            # Full suite (1199 unit + 23 conversation)
...
Current counts: ~1199 unit tests, 23 conversation-marked tests (20 quality scenarios + 3 safety-guard integration).
