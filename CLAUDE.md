...
# Tests
pytest tests/                            # Full suite (1181 unit + 23 conversation)
...
Current counts: ~1181 unit tests, 23 conversation-marked tests (20 quality scenarios + 3 safety-guard integration).
